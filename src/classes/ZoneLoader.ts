...
import { ZoneDefinition, ZoneID } from './index';

export type ZoneMap = Record<ZoneID, () => Promise<{ default: ZoneDefinition }>>;
...
export default class ZoneLoader {
     ...
     */
    private _zoneIsDefined(zoneID: ZoneID): zoneID is keyof typeof this._zoneMap {
        return this._zoneMap[zoneID as keyof typeof this._zoneMap] !== undefined;
    }
}
